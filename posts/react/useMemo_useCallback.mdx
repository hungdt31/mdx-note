...
- Một component bị **re-render** lại khi props truyền từ component cha nó bị thay đổi hoặc state nội tại của nó bị thay đổi.
- Code example:
...
$\Rightarrow$ Mỗi lần re-render `<App/>` phải tính toán lại giá trị Fibonacci gây lãng phí tài nguyên.
...
**useMemo Docs:** [https://react.dev/reference/react/useCallback](https://react.dev/reference/react/useCallback)

**useCallback Docs:** [https://react.dev/reference/react/useMemo](https://react.dev/reference/react/useMemo)